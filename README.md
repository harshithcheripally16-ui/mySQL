...
Each task is arranged in this order:

1. Table setup
2. Sample data insertion
3. Question
4. MySQL command used
5. Output returned by MySQL

This format keeps every question connected with the exact command used to solve it.
